...
![Alt text](1689578478901.png)
## 3.2 HTTPS协议改进过程
### 3.2.1 针对窃听风险
黑客可以嗅探通信内容
![Alt text](1689578514322.png)
![Alt text](1689578531456.png)
...
- 然后通过共同约定的密钥开始通信
![Alt text](1689578764672.png)
## 3.4 证书
证书的作用就是,我和服务端通信,我怎么知道这个服务端是我要真正通信的服务端呢
![Alt text](1689578790787.png)
### 3.4.1 申请和发放证书流程如下
![Alt text](1689578808089.png)
